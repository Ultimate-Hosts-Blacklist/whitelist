...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Testing of the whitelist list"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Testing of the whitelist list"
    ...
    # Current directory.
    current_dir = '/home/travis/build/Ultimate-Hosts-Blacklist/whitelist/'
